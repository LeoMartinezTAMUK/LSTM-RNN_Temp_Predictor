# Long Short-Term Memory (LSTM) Recurrent Neural Network (RNN) Implemenation for Global Monthly Temperature Mean Predictor
...
# Long Short-Term Memory (LSTM) RNN Implementation for Time Series Forecasting
...
lstm = LSTM(units=125, activation='tanh', return_sequences=False)(inputs)

# Dropout layer
dropout = Dropout(rate=0.15)(lstm)
